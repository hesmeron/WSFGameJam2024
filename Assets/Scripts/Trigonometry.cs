...
public static class Trigonometry 
{
    ...
    {
        GetCastPoint(from, to, pointToCast, out result, out float completion);
    }
    ...
    public static Vector3 Perpendicular(Vector3 a, Vector3 up)
    {
        return Vector3.Cross(a, up).normalized;
    }
}